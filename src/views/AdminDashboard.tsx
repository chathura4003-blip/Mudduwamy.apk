...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [adminSettingsForm, setAdminSettingsForm] = useState<AdminSettingsFormState>({
    ...
    email: user?.email || '',
    password: user?.plain_password || user?.password || '',
    showPassword: false,
    phone: user?.phone || '',
  ...
  useEffect(() => {
    if (user) {
      setAdminSettingsForm((prev) => ({
        ...
        password: user.plain_password || user.password || prev.password,
...
function isSameDataArray(prev: any[], next: any[]): boolean {
  ...
  const handleOpenEditStudent = (student: User) => {
    ...
    setStudentForm({
      ...
      email: student.email || '',
      password: student.plain_password || student.password || '',
  ...
  const handleOpenEditTeacher = (teacher: User) => {
    ...
    setTeacherForm({
      ...
      email: teacher.email || '',
      password: teacher.plain_password || teacher.password || '',
